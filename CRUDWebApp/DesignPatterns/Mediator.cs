...
namespace CRUDWebApp.DesignPatterns
{
    ...
    {        // Mediator is passed as argument in constructor
        ...
        {
            Console.WriteLine("North Stand sends message: " + message);
            mediator.SendMessage(message, this);
        }

        public void Notify(string message)
        {
            Console.WriteLine("North Stand gets message: " + message);
        }
    }
    ...
    {        // Mediator is passed as argument in constructor
        ...
        public void Send(string message)
        {
            Console.WriteLine("South Stand sends message: " + message);
            mediator.SendMessage(message, this);
        }

        public void Notify(string message)
        {
            Console.WriteLine("South Stand gets message: " + message);
        }
    }
}
